...
export namespace Prisma {
  ...
  */
  ...
  export type TableSelect = {
    ...
    status?: boolean
    deleted?: boolean
    orders?: boolean | Table$ordersArgs
  ...
  export class Prisma__TableClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    orders<T extends Table$ordersArgs= {}>(args?: Subset<T, Table$ordersArgs>): Prisma.PrismaPromise<Array<OrderGetPayload<T>>| Null>;
  ...
  export type OrderGetPayload<S extends boolean | null | undefined | OrderArgs> =
    ...
    ? Order  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'table' ? TableGetPayload<S['include'][P]> :
        P extends 'user' ? UserGetPayload<S['include'][P]> :
        P extends 'reservation' ? ReservationGetPayload<S['include'][P]> | null :
    ...
    : S extends { select: any } & (OrderArgs | OrderFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'table' ? TableGetPayload<S['select'][P]> :
        P extends 'user' ? UserGetPayload<S['select'][P]> :
        P extends 'reservation' ? ReservationGetPayload<S['select'][P]> | null :
  ...
  export type InvoiceSelect = {
    ...
    deleted?: boolean
    user?: boolean | UserArgs
    orders?: boolean | Invoice$ordersArgs
  ...
  export class Prisma__InvoiceClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    orders<T extends Invoice$ordersArgs= {}>(args?: Subset<T, Invoice$ordersArgs>): Prisma.PrismaPromise<Array<OrderGetPayload<T>>| Null>;
   ...
   * Invoice.orders
   */
  export type Invoice$ordersArgs = {
    /**
     * Select specific fields to fetch from the Order
     */
    select?: OrderSelect | null
  ...
  export type OrderWhereInput = {
    ...
    tableId?: IntFilter | number
    userId?: IntFilter | number
    reservationId?: IntNullableFilter | number | null
    observations?: StringNullableFilter | string | null
    createdAt?: DateTimeFilter | Date | string
    updatedAt?: DateTimeFilter | Date | string
    status?: StringFilter | string
  ...
  export type OrderScalarWhereWithAggregatesInput = {
    ...
    tableId?: IntWithAggregatesFilter | number
    userId?: IntWithAggregatesFilter | number
    reservationId?: IntNullableWithAggregatesFilter | number | null
    observations?: StringNullableWithAggregatesFilter | string | null
    createdAt?: DateTimeWithAggregatesFilter | Date | string
    updatedAt?: DateTimeWithAggregatesFilter | Date | string
    status?: StringWithAggregatesFilter | string
  ...
  export type OrderCreateNestedManyWithoutTableInput = {
    create?: XOR<Enumerable<OrderCreateWithoutTableInput>, Enumerable<OrderUncheckedCreateWithoutTableInput>>
    connectOrCreate?: Enumerable<OrderCreateOrConnectWithoutTableInput>
  ...
  export type OrderUpdateManyWithoutTableNestedInput = {
    create?: XOR<Enumerable<OrderCreateWithoutTableInput>, Enumerable<OrderUncheckedCreateWithoutTableInput>>
    connectOrCreate?: Enumerable<OrderCreateOrConnectWithoutTableInput>
    upsert?: Enumerable<OrderUpsertWithWhereUniqueWithoutTableInput>
    createMany?: OrderCreateManyTableInputEnvelope
    set?: Enumerable<OrderWhereUniqueInput>
    disconnect?: Enumerable<OrderWhereUniqueInput>
    delete?: Enumerable<OrderWhereUniqueInput>
    connect?: Enumerable<OrderWhereUniqueInput>
    update?: Enumerable<OrderUpdateWithWhereUniqueWithoutTableInput>
    updateMany?: Enumerable<OrderUpdateManyWithWhereWithoutTableInput>
    deleteMany?: Enumerable<OrderScalarWhereInput>
  }
  ...
  export type OrderCreateNestedManyWithoutInvoiceInput = {
    create?: XOR<Enumerable<OrderCreateWithoutInvoiceInput>, Enumerable<OrderUncheckedCreateWithoutInvoiceInput>>
    connectOrCreate?: Enumerable<OrderCreateOrConnectWithoutInvoiceInput>
  ...
  export type OrderUpdateManyWithoutInvoiceNestedInput = {
    create?: XOR<Enumerable<OrderCreateWithoutInvoiceInput>, Enumerable<OrderUncheckedCreateWithoutInvoiceInput>>
    connectOrCreate?: Enumerable<OrderCreateOrConnectWithoutInvoiceInput>
    upsert?: Enumerable<OrderUpsertWithWhereUniqueWithoutInvoiceInput>
    createMany?: OrderCreateManyInvoiceInputEnvelope
    set?: Enumerable<OrderWhereUniqueInput>
    disconnect?: Enumerable<OrderWhereUniqueInput>
    delete?: Enumerable<OrderWhereUniqueInput>
    connect?: Enumerable<OrderWhereUniqueInput>
    update?: Enumerable<OrderUpdateWithWhereUniqueWithoutInvoiceInput>
    updateMany?: Enumerable<OrderUpdateManyWithWhereWithoutInvoiceInput>
    deleteMany?: Enumerable<OrderScalarWhereInput>
  }
  ...
  export type OrderCreateManyTableInputEnvelope = {
    data: Enumerable<OrderCreateManyTableInput>
    skipDuplicates?: boolean
  }
  ...
  export type OrderCreateManyInvoiceInputEnvelope = {
    data: Enumerable<OrderCreateManyInvoiceInput>
    skipDuplicates?: boolean
  }
