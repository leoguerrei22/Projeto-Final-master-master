...
export namespace Prisma {
  ...
  */
  ...
  export type MesaCountOutputTypeGetPayload<S extends boolean | null | undefined | MesaCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? MesaCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (MesaCountOutputTypeArgs)
    ? MesaCountOutputType 
    : S extends { select: any } & (MesaCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
  ...
  export type ReservaGetPayload<S extends boolean | null | undefined | ReservaArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'mesa' ? MesaGetPayload<S['include'][P]> :
        P extends 'pedidos' ? Array < PedidoGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'mesa' ? MesaGetPayload<S['select'][P]> :
        P extends 'pedidos' ? Array < PedidoGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__ReservaClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    mesa<T extends MesaArgs= {}>(args?: Subset<T, MesaArgs>): Prisma__MesaClient<MesaGetPayload<T> | Null>;
  ...
  export type MesaSelect = {
    ...
    status?: boolean
    deleted?: boolean
    pedidos?: boolean | Mesa$pedidosArgs
    reservas?: boolean | Mesa$reservasArgs
  ...
  export type MesaGetPayload<S extends boolean | null | undefined | MesaArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Mesa :
    S extends undefined ? never :
    S extends { include: any } & (MesaArgs | MesaFindManyArgs)
    ? Mesa  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'pedidos' ? Array < PedidoGetPayload<S['include'][P]>>  :
        P extends 'reservas' ? Array < ReservaGetPayload<S['include'][P]>>  :
        P extends '_count' ? MesaCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (MesaArgs | MesaFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'pedidos' ? Array < PedidoGetPayload<S['select'][P]>>  :
        P extends 'reservas' ? Array < ReservaGetPayload<S['select'][P]>>  :
        P extends '_count' ? MesaCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Mesa ? Mesa[P] : never
  } 
      : Mesa
  ...
  export interface MesaDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Mesa'> extends True ? Prisma__MesaClient<MesaGetPayload<T>> : Prisma__MesaClient<MesaGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma__MesaClient<MesaGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Mesa'> extends True ? Prisma__MesaClient<MesaGetPayload<T>> : Prisma__MesaClient<MesaGetPayload<T> | null, null>
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<MesaGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MesaClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    pedidos<T extends Mesa$pedidosArgs= {}>(args?: Subset<T, Mesa$pedidosArgs>): Prisma.PrismaPromise<Array<PedidoGetPayload<T>>| Null>;

    reservas<T extends Mesa$reservasArgs= {}>(args?: Subset<T, Mesa$reservasArgs>): Prisma.PrismaPromise<Array<ReservaGetPayload<T>>| Null>;
   ...
   */
  export type MesaFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Mesa
     */
    select?: MesaSelect | null
   ...
   */
  export type MesaFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Mesa
     */
    select?: MesaSelect | null
  ...
  export type PedidoGetPayload<S extends boolean | null | undefined | PedidoArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'mesa' ? MesaGetPayload<S['include'][P]> :
        P extends 'utilizador' ? UtilizadorGetPayload<S['include'][P]> :
        P extends 'reserva' ? ReservaGetPayload<S['include'][P]> | null :
    ...
    [P in TruthyKeys<S['select']>]:
        P extends 'mesa' ? MesaGetPayload<S['select'][P]> :
        P extends 'utilizador' ? UtilizadorGetPayload<S['select'][P]> :
        P extends 'reserva' ? ReservaGetPayload<S['select'][P]> | null :
  ...
  export type ReservaScalarWhereWithAggregatesInput = {
    ...
    mesaId?: IntWithAggregatesFilter | number
  ...
  export type MesaScalarWhereWithAggregatesInput = {
    ...
    lugares?: IntWithAggregatesFilter | number
  ...
  export type PedidoWhereInput = {
    ...
    mesaId?: IntFilter | number
    utilizadorId?: IntFilter | number
    reservaId?: IntNullableFilter | number | null
    observacoes?: StringNullableFilter | string | null
    createdAt?: DateTimeFilter | Date | string
    updatedAt?: DateTimeFilter | Date | string
    status?: StringFilter | string
    faturaID?: IntNullableFilter | number | null
    precoTotal?: FloatFilter | number
    deleted?: BoolFilter | boolean
    mesa?: XOR<MesaRelationFilter, MesaWhereInput>
    utilizador?: XOR<UtilizadorRelationFilter, UtilizadorWhereInput>
    reserva?: XOR<ReservaRelationFilter, ReservaWhereInput> | null
  ...
  export type PedidoScalarWhereWithAggregatesInput = {
    ...
    mesaId?: IntWithAggregatesFilter | number
    utilizadorId?: IntWithAggregatesFilter | number
    reservaId?: IntNullableWithAggregatesFilter | number | null
    observacoes?: StringNullableWithAggregatesFilter | string | null
    createdAt?: DateTimeWithAggregatesFilter | Date | string
    updatedAt?: DateTimeWithAggregatesFilter | Date | string
    status?: StringWithAggregatesFilter | string
    faturaID?: IntNullableWithAggregatesFilter | number | null
    precoTotal?: FloatWithAggregatesFilter | number
    deleted?: BoolWithAggregatesFilter | boolean
  }
  ...
  export type FaturaScalarWhereWithAggregatesInput = {
    ...
    valorTotal?: FloatWithAggregatesFilter | number
    deleted?: BoolWithAggregatesFilter | boolean
  }
  ...
  export type MesaUpdateInput = {
    ...
    lugares?: IntFieldUpdateOperationsInput | number
  ...
  export type PedidoUpdateInput = {
    ...
    reserva?: ReservaUpdateOneWithoutPedidosNestedInput
  ...
  export type PedidoUncheckedUpdateInput = {
    ...
    mesaId?: IntFieldUpdateOperationsInput | number
    utilizadorId?: IntFieldUpdateOperationsInput | number
    reservaId?: NullableIntFieldUpdateOperationsInput | number | null
    observacoes?: NullableStringFieldUpdateOperationsInput | string | null
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    status?: StringFieldUpdateOperationsInput | string
  ...
  export type ReservaCreateNestedManyWithoutMesaInput = {
    create?: XOR<Enumerable<ReservaCreateWithoutMesaInput>, Enumerable<ReservaUncheckedCreateWithoutMesaInput>>
    connectOrCreate?: Enumerable<ReservaCreateOrConnectWithoutMesaInput>
  ...
  export type ReservaUpdateManyWithoutMesaNestedInput = {
    create?: XOR<Enumerable<ReservaCreateWithoutMesaInput>, Enumerable<ReservaUncheckedCreateWithoutMesaInput>>
    connectOrCreate?: Enumerable<ReservaCreateOrConnectWithoutMesaInput>
    upsert?: Enumerable<ReservaUpsertWithWhereUniqueWithoutMesaInput>
    createMany?: ReservaCreateManyMesaInputEnvelope
    set?: Enumerable<ReservaWhereUniqueInput>
    disconnect?: Enumerable<ReservaWhereUniqueInput>
    delete?: Enumerable<ReservaWhereUniqueInput>
    connect?: Enumerable<ReservaWhereUniqueInput>
    update?: Enumerable<ReservaUpdateWithWhereUniqueWithoutMesaInput>
    updateMany?: Enumerable<ReservaUpdateManyWithWhereWithoutMesaInput>
    deleteMany?: Enumerable<ReservaScalarWhereInput>
  }
  ...
  export type ReservaUpdateOneWithoutPedidosNestedInput = {
    create?: XOR<ReservaCreateWithoutPedidosInput, ReservaUncheckedCreateWithoutPedidosInput>
    connectOrCreate?: ReservaCreateOrConnectWithoutPedidosInput
  ...
  export type ReservaCreateManyMesaInputEnvelope = {
    data: Enumerable<ReservaCreateManyMesaInput>
    skipDuplicates?: boolean
  }
